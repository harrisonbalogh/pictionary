...
const SOCKET_MESSAGES = {
  ...
  KeepAlive: _message('keep_alive', {_serverIn}),
  ...
  GameEventIncorrectGuess: _message('game_event_incorrect_guess', {_clientIn}),

  // Painting
  StrokeStart: _message('stroke_start', {_clientIn, _serverIn}),
